...
class Param:
    ...
    def config(self):
        ...
        self.odrv.axis1.trap_traj.config.vel_limit = 9000
        self.odrv.axis0.trap_traj.config.vel_limit = 9000

        self.odrv.axis0.trap_traj.config.accel_limit = 6000
        self.odrv.axis1.trap_traj.config.accel_limit = 6000

        self.odrv.axis0.trap_traj.config.decel_limit = 6000
        self.odrv.axis1.trap_traj.config.decel_limit = 6000
    ...
    def raz_encoders(self):
        ...
        test = str(raw_input("Le robot est-il en l'air ? : [y] pour continuer \n"))
        if test == 'y' :
